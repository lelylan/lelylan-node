...
describe('Lelylan.Type',function() {
  ...
  describe('#public',function() {
    ...
    describe('with no search params', function() {
      ...
      beforeEach(function(done) {
        request = nock('http://api.lelylan.com').get('/types/public').replyWithFile(200, __dirname + '/fixtures/types.json');
        done();
      })

      beforeEach(function(done) {
        Lelylan.Type.public({}, function(e, r) {
          error = e; response = r; done();
        })
      })
    ...
    describe('with search params', function() {
      ...
      beforeEach(function(done) {
        request = nock('http://api.lelylan.com').get('/types/public?per=10').replyWithFile(200, __dirname + '/fixtures/types.json');
        done();
      })

      beforeEach(function(done) {
        Lelylan.Type.public({'per': 10}, function(e, r) {
          error = e; response = r; done();
        })
      })
