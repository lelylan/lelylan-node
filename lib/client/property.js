...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/properties#get-a-property).
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/properties#get-all-properties).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/properties#get-all-properties).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/properties#create-a-property).
	//
  // * `params` - An object containing the property params. [See accepted params](http://dev.lelylan.com/api/properties#create-a-property).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/properties#update-a-property).
	//
  // * `id` - A String that represents the ID of the desired property
  // * `params` - An object containing the property params. [See accepted params](http://dev.lelylan.com/api/properties#update-a-property).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/properties#delete-a-property).
	//
  // * `id` - A String that represents the ID of the desired property.
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
