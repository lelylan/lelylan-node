...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/subscriptions#get-all-subscriptions).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/subscriptions#get-all-subscriptions).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
