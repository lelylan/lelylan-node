...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/realtime#get-a-subscription).
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/realtime#get-all-subscriptions).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/realtime#get-all-subscriptions).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/realtime#create-a-subscription).
	//
  // * `params` - An object containing the subscription params. [See accepted params](http://dev.lelylan.com/api/realtime#create-a-subscription).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/realtime#update-a-subscription).
	//
  // * `id` - A String that represents the ID of the desired subscription
  // * `params` - An object containing the subscription params. [See accepted params](http://dev.lelylan.com/api/realtime#update-a-subscription).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/realtime#delete-a-subscription).
	//
  // * `id` - A String that represents the ID of the desired subscription.
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
