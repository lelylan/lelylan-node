...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/devices#get-all-info).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/devices#get-all-info).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/devices#activate-a-device).
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/devices#deactivate-a-device).
	//
  // * `activation_code` - A String that represents the device activation code.
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
