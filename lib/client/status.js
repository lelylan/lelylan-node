...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/statuses#get-a-status).
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/statuses#get-all-statuses).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/statuses#get-all-statuses).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/statuses#create-a-status).
	//
  // * `params` - An object containing the status params. [See accepted params](http://dev.lelylan.com/api/statuses#create-a-status).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/statuses#update-a-status).
	//
  // * `id` - A String that represents the ID of the desired status
  // * `params` - An object containing the status params. [See accepted params](http://dev.lelylan.com/api/statuses#update-a-status).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/statuses#delete-a-status).
	//
  // * `id` - A String that represents the ID of the desired status.
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
