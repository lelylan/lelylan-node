...
module.exports = function(config) {
  ...
  /**
   * Returns private information for a given status identified from its ID
   * @param {String} id The ID of the desired status.
   * @param {Function} callback The function to call with results, function({Error} error, {Object} results).
   * @see http://dev.lelylan.com/api/statuses#get-a-status-private-info
   */
  function privates(id, callback) {
    core.api('GET', '/statuses/' + id + '/privates', {}, callback);
  }
