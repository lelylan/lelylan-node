...
module.exports = function(config) {
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/functions#get-a-function).
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/functions#get-all-functions).
	//
  // * `options` - An object containing the search params. [See accepted params](http://dev.lelylan.com/api/functions#get-all-functions).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/functions#create-a-function).
	//
  // * `params` - An object containing the function params. [See accepted params](http://dev.lelylan.com/api/functions#create-a-function).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/functions#update-a-function).
	//
  // * `id` - A String that represents the ID of the desired function
  // * `params` - An object containing the function params. [See accepted params](http://dev.lelylan.com/api/functions#update-a-function).
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
	//
  ...
  // [Learn more on Dev Center](http://dev.lelylan.com/api/functions#delete-a-function).
	//
  // * `id` - A String that represents the ID of the desired function.
  // * `callback` - The callback function returning the results.
	// An error object is passed as first argument and the result as last.
