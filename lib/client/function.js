...
module.exports = function(config) {
  ...
  /**
   * Returns private information for a given function identified from its ID
   * @param {String} id The ID of the desired function.
   * @param {Function} callback The function to call with results, function({Error} error, {Object} results).
   * @see http://dev.lelylan.com/api/functions#get-a-function-private-info
   */
  function privates(id, callback) {
    core.api('GET', '/functions/' + id + '/privates', {}, callback);
  }
